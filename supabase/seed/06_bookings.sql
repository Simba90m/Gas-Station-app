...
-- Cairo time (+02:00). Booking 2 below deliberately crosses midnight into
-- 2024-06-16, demonstrating the late-night rule end to end.
-- ============================================================================
...
VALUES (
  ...
  NULL, NULL,
  tstzrange('2024-06-15 11:00:00+02', '2024-06-15 11:30:00+02'),
  'COMPLETED', 250
);
...
VALUES (
  ...
  tstzrange('2024-06-15 23:45:00+02', '2024-06-16 00:15:00+02'),
  'COMPLETED', 180
);
...
VALUES (
  ...
  tstzrange('2024-06-16 14:00:00+02', '2024-06-16 14:30:00+02'),
  'CONFIRMED', 70
);
...
VALUES (
  ...
  tstzrange('2024-06-17 10:00:00+02', '2024-06-17 10:30:00+02'),
...
VALUES (
  ...
  NULL,
  tstzrange('2024-06-20 01:00:00+02', '2024-06-20 01:45:00+02'),
  'PENDING', 200
);
...
VALUES
  ('80000000-0000-0000-0000-000000000001', '30000000-0000-0000-0000-000000000005', 1, 0, 'COMPLETED', '2024-06-15 09:05:00+02', '2024-06-15 09:10:00+02'),
  ('80000000-0000-0000-0000-000000000001', '30000000-0000-0000-0000-000000000004', 2, 5, 'CALLED', '2024-06-15 09:12:00+02', NULL),
